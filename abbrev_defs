...
(define-abbrev-table 'shell-mode-abbrev-table
  '(
    ...
    ("kagetpods" "kubectl get pods -n echetia-sctp-server" nil 5)
    ...
    ("kakbdescribe" "kubectl describe pod echetia-tfvrc-0 -n echetia-sctp-server" nil 15)
    ...
    ("kamoshell" "ssh eccd@10.196.109.152 && ssh 10.0.10.3 && cd ~/moshell/latest/bin" nil 0)
    ("kamotransport" "ManagedElement=1,Transport=1" nil 4)
    ("kasctpiterminate" "sctpi terminateService --clientId 101" nil 1)
    ("kasetmje" "sed -i \"s/esignum/echetia/g\" /repo/echetia/sctp/test/target/mje/module/msran.properties" nil 4)
    ("kasetup" "cd /repo/echetia/sctp/ && source env.bash && source env/setup.bash STP_ClusA_02" nil 49)
